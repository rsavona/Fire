...
public class FileMessageElement : ElementBase<FileMessageElement.State, FileMessageElement.Event, DeviceMetric>, IMessageProvider
{
    ...
    public FileMessageElement(IMessageBus bus, IDeviceConfig config, IFireLogger logger, LoggingLevelSwitch swtch)
