...
/// <summary>
/// A specialized device for database maintenance tasks like pruning old records.
/// </summary>
public class DatabasePruningDevice(IMessageBus bus, IDeviceConfig config, IFireLogger logger) 
    : MsSqlDatabaseDevice(bus, config, logger)
{
