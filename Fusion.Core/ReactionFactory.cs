...
public class WorkflowFactory : IWorkflowFactory
{
    ...
    public IHostedService CreateWorkflow(WorkflowConfig config)
    {
        ...
        // We match case-insensitive on the Class CustomerName (e.g., "WorkflowPrintAndApplyFrc")
        ...
        {
            Serilog.Log.Error("Could not find a force implementation for type '{WorkflowType}'. Ensure the DLL is loaded and the class inherits from ReactionBase.", config.Type);
