...
namespace Device.ActiveMQ
{
    ...
    /// </summary>
    public class ActiveMqBrowserDevice : ClientDeviceBase
    {
        ...
        public ActiveMqBrowserDevice(IMessageBus bus, IDeviceConfig config, IFireLogger logger, LoggingLevelSwitch ls)
