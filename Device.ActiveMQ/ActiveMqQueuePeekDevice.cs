...
namespace Device.ActiveMQ
{
    ...
    /// </summary>
    public class ActiveMqQueuePeekDevice : ClientDeviceBase
    {
        ...
        public ActiveMqQueuePeekDevice(IMessageBus bus, IDeviceConfig config, IFireLogger logger, LoggingLevelSwitch ls)
