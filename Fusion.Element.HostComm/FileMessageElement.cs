...
public class FileMessageElement : ElementBase<FileMessageElement.State, FileMessageElement.Event, ElementMetric>, IMessageProvider
{
    ...
    public FileMessageElement(IMessageBus bus, IElementBlueprint config, IFireLogger logger, LoggingLevelSwitch swtch)
    ...
    protected override ElementHealth MapStateToHealth(State state) => state switch
    {
        ...
        State.Processing => ElementHealth.Normal,
