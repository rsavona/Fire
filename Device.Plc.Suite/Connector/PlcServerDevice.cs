...
public class PlcServerDevice : TcpServerMultiClientDeviceBase<PlcMessageProcessor>, IMessageProvider
{
    ...
    /// </param>
    public PlcServerDevice(IDeviceConfig config, ILogger deviceLogger)
        : base(
            config,
            deviceLogger,
