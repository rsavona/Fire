...
{
    public class PrintClientBaseElementJetMark :  TcpClientElementBase,  IMessageProvider, ITcpPrintClientBase
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        /// <param name="ls"></param>
        public PrintClientBaseElementJetMark(IMessageBus bus, IElementBlueprint config, IFireLogger zebraLogger, LoggingLevelSwitch ls) : base(
