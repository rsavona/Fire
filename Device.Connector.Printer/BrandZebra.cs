...
public class BrandZebra : TcpClientDeviceBase, IMessageProvider, ITcpPrinter
{
    ...
    public BrandZebra(IDeviceConfig config, ILogger zebraLogger) : base(config, zebraLogger) 
    {
