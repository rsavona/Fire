...
public class PlcMultiClientDevice : TcpServerMultiClientDeviceBase<PlcMessageProcessor>, IMessageProvider
{
    ...
    /// </param>
    public PlcMultiClientDevice(IDeviceConfig config, ILogger deviceLogger)
        : base(
            config,
            deviceLogger,
            new PlcMessageProcessor(new PlcMessageParser(), config.Name),
    ...
    private void OnProcessorMessageReceived(MessageEnvelope message)
    {
        ...
        Machine.FireAsync(Event.MessageReceived);   
