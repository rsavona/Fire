...
/// </remarks>
public readonly struct BondKey : IEquatable<BondKey>
{
    /// <summary>
    /// The starting point or originator of the bond/message.
    /// </summary>
    public string Source { get; }

    /// <summary>
    /// The ending point or intended recipient of the bond/message.
    /// </summary>
    public string Destination { get; }

    /// <summary>
    /// Initializes a new instance of the BondKey struct.
    /// </summary>
    /// <param name="source">The source identifier.</param>
    /// <param name="destination">The destination identifier.</param>
    public BondKey(string source, string destination)
    {
    ...
    /// <summary>
    /// Checks if this BondKey is equal to another BondKey instance.
    /// </summary>
    public bool Equals(BondKey other)
    {
    ...
    /// <summary>
    /// Checks if this BondKey is equal to a generic object.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is BondKey other && Equals(other);
    }
    ...
    /// <summary>
    /// Provides a string representation of the bond key (e.g., "Source->Destination").
    /// </summary>
    ...
    public static bool operator ==(BondKey left, BondKey right)
    {
