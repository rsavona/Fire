...
public sealed record StatusTracker<TState, TEvent> : IStatusTracker
...

{
    ...
    public ElementStatusMessage ToStatusMessage(ElementKey key, string comment = "", int resTasks = 0, int resContainers = 0, int resDeepCount = 0)
    {
